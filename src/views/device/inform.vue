  ...
  <div>
    <b-modal id="modal-device-inform" :title="getTitle" @ok="onSubmit">
      <div>
        ...
        <b-form-group label="장비이름" label-for="name" label-cols="3">
          <b-form-input id="name" v-model="device.name"></b-form-input>
        </b-form-group>
        <b-form-group label="장비모델명" label-for="deviceModelName" label-cols="3">
          <b-form-input id="deviceModelName" v-model="device.deviceModelName"></b-form-input>
        </b-form-group>
        <b-form-group label="모델명" label-for="menufacturer" label-cols="3">
          <b-form-input id="menufacturer" v-model="device.menufacturer"></b-form-input>
        </b-form-group>
        <b-form-group label="설치위치" label-for="location" label-cols="3">
          <b-form-input id="location" v-model="device.location"></b-form-input>
        </b-form-group>
        <b-form-group label="엣지 시리얼 넘버" label-for="edgeSerialNumber" label-cols="3">
          <b-form-input id="edgeSerialNumber" v-model="device.edgeSerialNumber"></b-form-input>
        </b-form-group>
        <b-form-group label="통신인터페이스" label-for="networkInterface" label-cols="3">
