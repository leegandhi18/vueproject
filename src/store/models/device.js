...
export default {
  ...
  actions: {
    ...
    actDeviceList(context, payload) {
      console.log('actDeviceList', payload)
      /* 테스트 데이터 세팅 */
      const DeviceList = [
        {
          id: 1,
    ...
    actDeviceInputMode(context, payload) {
      console.log('actDeviceInputMode', payload)
      context.commit('setInputMode', payload)
    },
    // 상세정보 조회
    actDeviceInfo(context, payload) {
      console.log('actDeviceInfo', payload)
      // 상태값 초기화
      context.commit('setDevice', { ...stateInit.Device })
      setTimeout(() => {
        /* 테스트 데이터 세팅 */
        const DeviceList = [
          {
            ...
            deletedAt: '2021-12-03T00:00:00.000Z'
          },
          {
            id: 2,
            name: 'Edge1',
